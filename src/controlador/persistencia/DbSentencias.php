...
interface DbSentencias {
    ...
    const VERIFICAR_HORARIO_SOLAPADO= "SELECT EXISTS(SELECT horarios.* FROM horarios WHERE fk_profesor=? AND (fk_modulo_inicio<? OR fk_modulo_fin>?) AND dia_horario=? AND ciclo_lectivo_horario=? AND estado=1) AS existe;";
    //Plan de Estudios

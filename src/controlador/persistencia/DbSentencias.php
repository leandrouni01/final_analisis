...
interface DbSentencias {
    ...
    const INSERTAR_PROFESOR= "INSERT INTO profesor(cargo,nombre_profesor,apellido_profesor,fk_titulo,fk_postgrado,fk_domicilio,dni_profesor) VALUES(?,?,?,?,?,(SELECT MAX(id_domicilio) FROM domicilio),?);";
    ...
    const ACTUALIZAR_PROFESOR= "UPDATE profesor SET cargo=?,nombre_profesor=?,apellido_profesor=?,fk_titulo=?,fk_postgrado=?,fk_domicilio=?,dni_profesor=? WHERE id_profesor=?;";

...
interface DbSentencias {
    ...
    const VERFICAR_HORARIO_TOMADO= "SELECT EXISTS(SELECT horarios.* FROM horarios WHERE fk_materia=? AND fk_modulo_inicio=? AND fk_modulo_fin=? AND fk_curso=? AND dia_horario=? AND ciclo_lectivo_horario=? AND estado=1) AS existe;";
    //Plan de Estudios
